...
if (!defined('DB_NAME')) define('DB_NAME', 'vhvxoigh_ideas_erp');
if (!defined('DB_CHARSET')) define('DB_CHARSET', 'utf8mb4');

// ── JWT secret (change in production!) ─────────
if (!defined('JWT_SECRET')) define('JWT_SECRET', 'IDEASCRM_S3cr3t_K3y_2025!@#$%');
...
// ── CORS ───────────────────────────────────────
if (!defined('ALLOWED_ORIGINS')) define('ALLOWED_ORIGINS', 'http://localhost:5173,http://localhost:3000,http://open.Ideas.test,https://open.Ideas.test');
