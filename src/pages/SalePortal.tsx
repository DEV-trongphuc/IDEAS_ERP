                    ...
                    <div className="form-group" style={{ marginTop: '0.5rem', paddingTop: '1rem', borderTop: '1px solid var(--color-border-light)' }}>
                      ...
                      {saleSignatureUrl ? (
                        <div style={{
                          ...
                          <img 
                            src={saleSignatureUrl ? (saleSignatureUrl.startsWith('http') || saleSignatureUrl.startsWith('data:') ? saleSignatureUrl : `https://open.domation.net/ideas/${saleSignatureUrl.replace(/^\/+/, '')}`) : ''} 
                            alt="Chữ ký mẫu" 
